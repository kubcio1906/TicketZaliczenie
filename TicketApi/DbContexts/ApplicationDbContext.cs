...
namespace TicketApi.DbContexts
{
    ...
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration<Ticket>(new TicketConfiguration());
            ...
            builder.Entity<Ticket>().HasData(new Ticket { EventId = 1, TicketId = 1, City = "Kasztan", Price = 149, TakePlace = time });
        }
